...
describe("NFTMarketplace", function () {
  ...
  describe("Purchasing marketplace items", function () {
    ...
    it("Should update item as sold, pay seller, transfer NFT to buyer, charge fees and emit a Bought event", async function () {
      // first we will fetch balance of each account
      ...
      // after purchasing Item we will fetch balance of both account
      ...
      // console.log("initialBalance: ", fromWei(feeAccountInitialEthBal));
      // console.log("Fee: ", fee);
      // console.log("final Balance: ", fromWei(feeAccountFinalEthBal));
      // console.log(
